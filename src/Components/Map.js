...
function Map() {
  ...
  return (
    <div>
      ...
      <LoadScript googleMapsApiKey="AIzaSyDjD4lGFnY7plUA4lmRqm7k5GOxRWbPwtY">
        <GoogleMap
          ...
          {selectedFriend ? (
            ...
            >
              <div>
                ...
                <h3>
                  Jacopo is at<a href="">"joes Pizza"</a>{" "}
                </h3>
                <p>
                  Having a blast, haha get it? cause it's a laser tag place.{" "}
                  <br />
                  Come join if your in the area. Be here till 7pm.
                </p>
                <button>CHAT</button>
              </div>
            </InfoWindow>
